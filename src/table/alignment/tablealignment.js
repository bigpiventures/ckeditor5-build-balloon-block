...
import TableAlignmentEditing from './tablealignmentediting';
import TableAlignmentUI from './tablealignmentui';
 ...
 */
export default class TableAlignment extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get requires() {
		return [ TableAlignmentEditing, TableAlignmentUI ];
	}
